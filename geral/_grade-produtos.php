<?php
/**
 * Parcial reutilizável — grade de cards de produto.
 * @var array $produtos Lista de produtos (formato de obterProdutosAtivos()).
 * @var string $voltarParaCategoria URL de retorno pros forms de favoritar/adicionar ao carrinho.
 */
?>
            ...
            <div class="position-relative">
                <?php if (clienteLogado()): ?>
                    <form method="post" action="<?= URL_BASE ?>/usuario/favoritos.php" class="position-absolute top-0 end-0 m-2" style="z-index: 2;">
                        ...
                        <input type="hidden" name="voltar_para" value="<?= htmlspecialchars($voltarParaCategoria) ?>">
